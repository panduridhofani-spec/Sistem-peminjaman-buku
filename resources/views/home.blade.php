...
<body class="bg-gradient-to-b from-purple-700 to-purple-950 text-white min-h-screen pt-36">
    ...
    <nav class="bg-purple-900 p-4 fixed top-0 w-full z-30 shadow-lg" style="background-color: #551A8B;">
        <div class="flex items-center justify-between mx-auto px-6 py-1 md:px-12">
            ...
            <div class="flex items-center space-x-4 md:space-x-6 text-lg font-medium ml-auto">
                ...
                <a href="/tentang-kami" class="hover:text-yellow-300 transition hidden md:block">Tentang Kami</a>
    ...
    <div id="login-modal" class="modal-overlay fixed inset-0 z-50 flex items-center justify-center hidden">
        <div
            class="bg-purple-900 rounded-2xl p-8 shadow-2xl w-full max-w-md mx-4 border-2 border-yellow-400 text-center">
