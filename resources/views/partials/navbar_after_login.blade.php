...
<nav class="p-4 fixed top-0 w-full z-30 shadow-lg" style="background-color: #551A8B;">
    <div class="flex items-center justify-between mx-auto px-6 py-1 md:px-12">
        ...
        <!-- Logo (Kiri) -->
        <a href="/dashboard_after_login" class="flex items-center space-x-2">
        ...
        <div class="flex items-center space-x-4 md:space-x-6 text-lg font-medium ml-auto">
            ...
            <!-- Link Navigasi -->
            <a href="/dashboard_after_login" class="hover:text-yellow-300 transition hidden md:block">Home</a>
            <a href="/tentang_kami_after_login" class="hover:text-yellow-300 transition hidden md:block">Tentang Kami</a>
